      ...
      <nav className="sticky h-[64px] top-0 bg-white shadow-sm z-50 relative">
        ...
        <div className="container mx-auto px-4 pt-[15px] pb-[14px] flex justify-end items-center">
          <div className="flex space-x-4">
            ...
            <button
              type="button"
              className="text-white bg-custom-teal hover:bg-teal-700 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 mb-0"
            >
              Get started
            </button>
          </div>
